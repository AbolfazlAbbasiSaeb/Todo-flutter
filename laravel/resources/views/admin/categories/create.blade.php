						...
						<div class="col-lg-12 col-sm-12 col-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
									<form class="row w-100" method="POST" action="{{ route('admin.categories.store') }}">
										@csrf
										...
										<div class="col-lg-4">
											<div class="input-group mb-3">
                                        		<input type="text" id="name" value="{{old('name')}}" class="form-control" placeholder="عنوان" name="name">
											</div>
										</div>
										<div class="col-lg-4 my-auto">
											@error('name')
